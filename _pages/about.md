...
<img src="https://mengtong0110.github.io/images/profile_2.jpg" class="author__avatar" alt="Meng Tong's Avatar" style="width: 200px; height: 300px;">
  </div>
      ...
      <ul class="author__urls social-icons" style="list-style: none; padding-left: 0;">
        <li style="display: inline-block; margin-right: 10px;">
          <a href="https://twitter.com/mengtong0110" style="text-decoration: none; font-size: 14px; color: black;">
            <i class="fab fa-fw fa-twitter-square" aria-hidden="true"></i> Twitter&nbsp;&ensp;
          </a>
        </li>
        <li style="display: inline-block; margin-right: 10px;">
...
<div style="font-size: 0.9em; width: 90%; text-align: left;">
  ...
  <a href="https://ctftime.org/team/168863" target="_blank" style="text-decoration: none; color: #005fa3;">NEBULA</a>, which ranked in the top 0.33% globally. During this time, I also served as a teaching assistant for Prof. <a href="https://seedsecuritylabs.org/wenliangdu/" target="_blank" style="text-decoration: none; color: #005fa3;">Wenliang Du</a>'s SEED project, mentoring young Chinese professors on classical system vulnerabilities.
